    ...
    <div style={{ width: '100%', maxWidth: '400px', flexShrink: 0 }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
        {[
          ...
          <Link key={label} href={href} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px 10px', borderRadius: '10px', background: 'white', textDecoration: 'none', color: '#4256c8', fontWeight: 600, fontSize: '13px', textAlign: 'center', lineHeight: 1.3 }}>
            {label}
          </Link>
        ))}
      </div>
