          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '16px 20px 20px', minHeight: 0 }}>
            ...
            {etapa === 1 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', flex: 1 }}>
                ...
                {exibeFoto && <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
                  <label style={rotuloCampo}>{fotoObrigatoria ? 'Foto *' : 'Foto'}</label>
                  {!fotoPreview ? (
                    <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1, minHeight: '56px', border: '2px dashed #e5e7eb', borderRadius: '8px', textAlign: 'center', cursor: 'pointer' }}>
                    ...
                    <div style={{ position: 'relative', borderRadius: '8px', overflow: 'hidden', border: '1px solid #e5e7eb', flex: 1, minHeight: '56px' }}>
