...
export function SidebarImoveis({
  imoveis, filtro, selecionado, setSelecionado,
  ...
  // "Imóveis" na barra flutuante (MapaTopBar.tsx via MapaDemandas.tsx).
  filtro: string
  ...
  return (
    <>
      ...
      >
        ...
        {/* Filtro de finalidade saiu daqui (pedido do usuário, 2026-09-04):
            agora é o dropdown do próprio chip "Imóveis" na barra flutuante
