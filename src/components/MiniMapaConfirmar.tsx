        ...
        <div style={{ position: 'absolute', bottom: '8px', left: '8px', right: '8px', zIndex: 1000, background: 'white', borderRadius: '8px', padding: '6px 8px', boxShadow: '0 1px 6px rgba(0,0,0,0.25)', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '5px', justifyContent: 'center' }}>
            <button type="button" onClick={voltarDaRevisao}
              style={{ background: '#e5e7eb', color: '#111827', border: 'none', borderRadius: '12px', padding: '3px 10px', fontSize: '10px', fontWeight: 600, cursor: 'pointer' }}>
              Voltar
            </button>
            <button type="button" onClick={confirmarFinal}
              style={{ background: '#4256c8', color: 'white', border: 'none', borderRadius: '12px', padding: '3px 10px', fontSize: '10px', fontWeight: 600, cursor: 'pointer' }}>
              Confirmar
            </button>
          </div>
        </div>
